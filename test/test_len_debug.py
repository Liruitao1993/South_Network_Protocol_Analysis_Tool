...
print(f"Frame bytes 32:124: {frame_bytes[32:124].hex()}")
print(f"Frame bytes 32:124 length: {len(frame_bytes[32:124])}")
...
for i, row in enumerate(result):
    if 'MSDU' in row[0] or 'MAC' in row[0] or 'VLAN' in row[0]:
